...
const db = {
  ...
  addSolve(uid, cid, pts) {
    ...
    // increment solve_count on challenge
    const idx = CHALLENGES.findIndex(c => c.id === cid);
    if (idx !== -1) CHALLENGES[idx].solve_count = (CHALLENGES[idx].solve_count || 0) + 1;
  },
...
const CHALLENGES = [
  // WEB
  { id:1,  slug:'web-flask-session',   category:'WEB',       title:'Flask Session',
    ...
    difficulty:'Easy',   base_points:100,  flag:'FLAG{y0u_1s_G4y?Y3s!}',
  ...
  { id:2,  slug:'web-babel-stage1',    category:'WEB',       title:'The Babel Protocol — Stage 1',
    ...
    difficulty:'Hard',   base_points:300,  flag:'QA{w4sm_r3v3rs1ng_xxe_00b_ssrf_ch41n}',
  ...
  { id:3,  slug:'web-babel-stage2',    category:'WEB',       title:'The Babel Protocol — Stage 2',
    ...
    difficulty:'Insane', base_points:500,  flag:'QA{sst1_f0rg3d_s3ss10n_rc3_ch41n_byp4ss}',
  ...
  { id:4,  slug:'web-babel-stage3',    category:'WEB',       title:'The Babel Protocol — Stage 3',
    description:'HTTP Request Smuggling meets a 3 ms Race Condition. Smuggle the required internal headers to grant yourself admin, win the race into the vault, and decrypt the XOR-encoded flag.',
    difficulty:'Insane', base_points:500,  flag:'QA{smuggl1ng_r4c3_c0nd1t10n_ful1_syst3m_t4k30v3r}',
    hint:'Smuggle X-Internal-Token, X-Real-Source:127.0.0.1, X-Bypass-WAF:true. XOR key = MD5(seed+INTERNAL_TOKEN)[:5].',
    hint_cost:350, solve_count:0, author:'G4ram' },

  // PWN
  { id:5,  slug:'pwn-overvaulted',     category:'PWN',       title:'OverVaulted',
    ...
    difficulty:'Medium', base_points:200,  flag:'QA{0v3r_v4ult3d_h34p_0verfl0w}',
  ...
  { id:6,  slug:'pwn-obsidian-vm',     category:'PWN',       title:'Obsidian VM',
  ...
  { id:7,  slug:'pwn-ksmbd',           category:'PWN',       title:'KsmbDead',
    ...
    difficulty:'Insane', base_points:500,  flag:'QA{k3rn3l_ksmb_d34d_r00t_esc4p3}',
  ...
  // REV
  { id:8,  slug:'rev-vietnamese',      category:'REV',       title:'Vietnamese Identity',
    ...
    difficulty:'Easy',   base_points:100,  flag:'QA{be-qa-la-nguoi-viet-nam}',
    hint:'Read the bundled .c source. Trace the per-byte transforms and invert them one by one.',
    hint_cost:50, solve_count:0, author:'G4ram' },

  { id:9,  slug:'rev-custom-hulk',     category:'REV',       title:'Custom Hulk',
  ...
  { id:10, slug:'rev-vaultvm2',        category:'REV',       title:'VaultVM 2',
    ...
    difficulty:'Hard',   base_points:350,  flag:'QA{v4ult_vm2_jit_c0rrupt10n}',
    hint:'flag_printer @ 0x402c69. func_table[0] = jit_page+256. Use opcode 0x7e to STORE arbitrary values into the JIT page.',
    hint_cost:200, solve_count:0, author:'G4ram' },

  { id:11, slug:'rev-the-abyss',       category:'REV',       title:'The Abyss',
    ...
    difficulty:'Insane', base_points:500,  flag:'QA{4byss_vm_r3v_ch4ll3ng3}',
    hint:'Transform pipeline: XOR 0x5A → ADD i*7 → XOR 0xC3. Patch the debug check in bytecode or compute the inverse directly.',
    hint_cost:350, solve_count:0, author:'G4ram' },

  // CRYPTO
  { id:12, slug:'crypto-spectral',     category:'CRYPTO',    title:'Spectral',
    ...
    difficulty:'Hard',   base_points:350,  flag:'QA{sp3ctr4l_k3y_r3c0v3ry}',
  ...
  { id:13, slug:'crypto-aegis',        category:'CRYPTO',    title:'Aegis',
    ...
    difficulty:'Hard',   base_points:350,  flag:'QA{4eg1s_p0hl1g_h3llm4n_dlp}',
  ...
  { id:14, slug:'crypto-meridian',     category:'CRYPTO',    title:'Meridian',
    ...
    difficulty:'Insane', base_points:500,  flag:'QA{m3r1d14n_lw3_k3y_r3c0v3ry}',
  ...
  { id:15, slug:'crypto-triple-veil',  category:'CRYPTO',    title:'Triple Veil',
    ...
    difficulty:'Insane', base_points:500,  flag:'QA{tr1pl3_v31l_m4st3r_k3y}',
    hint:'Part 1: EXIF Comment of hint_image.png. Part 2: base64-decode body of pubkey.pem. Part 3: integrity field in config.json.',
    hint_cost:350, solve_count:0, author:'G4ram' },

  // FORENSICS
  { id:16, slug:'for-echoing-void',    category:'FORENSICS', title:'The Echoing Void',
    ...
    difficulty:'Insane', base_points:500,  flag:'QA{dns_c0v3rt_ch4nn3l_dg4_3xf1l}',
    hint:'Filter DNS queries with QNAME entropy > 4.0. XOR key for each chunk = TTL bytes of the corresponding DNS response.',
    hint_cost:450, solve_count:0, author:'G4ram' },

  { id:17, slug:'for-rootkit',         category:'FORENSICS', title:'Rootkit Extraction',
    ...
    difficulty:'Insane', base_points:500,  flag:'QA{r00tk1t_k3rn3l_k3y_d3r1v3d}',
  ...
  { id:18, slug:'for-digital-trail',   category:'FORENSICS', title:'Digital Trail',
    ...
    difficulty:'Hard',   base_points:350,  flag:'QA{m3m0ry_t3lls_4ll_s3cr3ts_fr0m_sl4ck_t0_h34p}',
  ...
  // MISC
  { id:19, slug:'misc-pulse',          category:'MISC',      title:'The Pulse',
  ...
  { id:20, slug:'misc-hexagonal',      category:'MISC',      title:'Hexagonal Veil',
    ...
    difficulty:'Medium', base_points:200,  flag:'QA{boot2root_hi_1_4m_Quynh4nh}',
    hint:'Hunt for bytes 51 41 43 54 46 00 00 01. Next 2 bytes = payload length. XOR key = SHA256(flag_bytes)[:8].',
    hint_cost:100, solve_count:0, author:'G4ram' },

  { id:21, slug:'misc-hidden',         category:'MISC',      title:'Hidden in Plain Sight',
    ...
    difficulty:'Medium', base_points:200,  flag:'QA{h1dd3n_1n_pl41n_s1ght_lsb}',
